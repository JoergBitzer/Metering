...
//==============================================================================
SimpleMeterProcessor::SimpleMeterProcessor()
...
//==============================================================================
const juce::String SimpleMeterProcessor::getName() const
{
    return JucePlugin_Name;
}

bool SimpleMeterProcessor::acceptsMidi() const
{
...
bool SimpleMeterProcessor::producesMidi() const
{
...
bool SimpleMeterProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double SimpleMeterProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int SimpleMeterProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int SimpleMeterProcessor::getCurrentProgram()
{
    return 0;
}

void SimpleMeterProcessor::setCurrentProgram (int index)
{
    juce::ignoreUnused (index);
}

const juce::String SimpleMeterProcessor::getProgramName (int index)
{
    juce::ignoreUnused (index);
    return {};
}

void SimpleMeterProcessor::changeProgramName (int index, const juce::String& newName)
{
    juce::ignoreUnused (index, newName);
}

//==============================================================================
void SimpleMeterProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void SimpleMeterProcessor::releaseResources()
{
    // When playback stops, you can use this as an opportunity to free up any
    // spare memory, etc.
}

bool SimpleMeterProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void SimpleMeterProcessor::processBlock (juce::AudioBuffer<float>& buffer,
...
//==============================================================================
bool SimpleMeterProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* SimpleMeterProcessor::createEditor()
{
    return new SimpleMeterProcessorEditor (*this);
}

//==============================================================================
void SimpleMeterProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void SimpleMeterProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new SimpleMeterProcessor();
}
